import { Badge, Button, Dropdown, Layout, Menu, MenuProps, Image, List, Avatar, Alert, notification } from 'antd';
    ...
    return (
        <Context.Provider value={{ 'name': '' }}>
            ...
            <Layout className="layout">
                ...
                <Login setIsLogged={setIsLogged} visible={openLogin} onCancel={() => onCancelLogin()} />
            </Layout>
        </Context.Provider>
    );
};
